...
export function ImportClassModal({ isOpen, onClose, onSuccess }: ImportClassModalProps) {
  ...
  const performImport = async (classInfo: any, students: any[], events: any[], targetClassId?: string) => {
    ...
    try {
      ...
      const result = await importClassFromExcel(classInfo, students, events, user.id, targetClassId)
  ...
  // quando o instrutor abre uma turma de outro semestre com o mesmo nome.
